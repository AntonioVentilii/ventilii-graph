...
export const portfolioData: PortfolioData = {
	...
	categories: [
		...
		},
		{
			...
			shortHint: L.en('Languages, frontend, Web3, platforms.', 'Linguaggi, frontend, Web3, piattaforme.'),
		},
		{
			id: 'education',
		...
		},
		{
			...
			shortHint: L.en('Spoken languages — UI copy stays in your toggle.', 'Lingue parlate — l’interfaccia segue il selettore.'),
		},
		{
			id: 'about',
	...
	experiences: [
		{
			...
			links: [
				{ label: L.en('OISY on GitHub', 'OISY su GitHub'), href: 'https://github.com/dfinity/oisy-wallet' },
		...
		},
		{
			...
			location: L.en('Zurich, Switzerland', 'Zurigo, Svizzera'),
			role: L.en('Desk Developer / Senior Multi-Asset Trader', 'Desk Developer / Senior Multi-Asset Trader'),
		...
		},
		{
			...
			highlights: [
				...
				L.en('Trade ideas for Direct Access clients in Derivatives and Fixed Income.', 'Idee di trade per Direct Access in Derivati e Fixed Income.'),
			],
			stackIds: ['python'],
		},
		{
			...
			role: L.en('Desk Developer / Financial Specialist, Treasury & Risk', 'Desk Developer / Financial Specialist, Treasury & Risk'),
			...
			highlights: [
				L.en('Market data: Bloomberg, Yahoo, APIs, scraping.', 'Market data: Bloomberg, Yahoo, API, scraping.'),
		...
		},
		{
			...
			highlights: [
				L.en('Automation with layered security and redundancy.', 'Automazione con sicurezza a strati e ridondanza.'),
			],
			stackIds: ['python'],
		},
	],
	projects: [
		{
			...
			highlights: [
				L.en('Apache-2.0, TypeScript + Svelte frontend, Rust canisters, chain fusion (Bitcoin, Ethereum-family, Solana).', 'Apache-2.0, frontend TS/Svelte, canister Rust, chain fusion (BTC, EVM, Solana).'),
			],
			links: [
		...
		},
		{
			...
			links: [{ label: L.en('GitHub', 'GitHub'), href: 'https://github.com/AntonioVentilii/icdc-core' }],
			stackIds: ['rust', 'icp'],
		},
		{
			id: 'escrow',
			...
			links: [{ label: L.en('GitHub', 'GitHub'), href: 'https://github.com/AntonioVentilii/escrow' }],
			stackIds: ['react'],
		},
		{
			id: 'vici-app',
			...
			kind: 'personal',
			summary: L.en('Svelte app — recently active on GitHub.', 'App Svelte — attività recente su GitHub.'),
			links: [{ label: L.en('GitHub', 'GitHub'), href: 'https://github.com/AntonioVentilii/vici-app' }],
		...
		},
		{
			...
			links: [
				{ label: L.en('vault-core', 'vault-core'), href: 'https://github.com/AntonioVentilii/vault-core' },
				{ label: L.en('vault-app', 'vault-app'), href: 'https://github.com/AntonioVentilii/vault-app' },
			],
		...
		},
		{
			...
			links: [{ label: L.en('GitHub', 'GitHub'), href: 'https://github.com/AntonioVentilii/icrc-factory' }],
			stackIds: ['rust', 'icp'],
		},
		{
			id: 'deribit-wrapper',
			...
			kind: 'personal',
			summary: L.en('Python integration layer for Deribit’s trading API.', 'Wrapper Python per API trading Deribit.'),
			links: [{ label: L.en('GitHub', 'GitHub'), href: 'https://github.com/AntonioVentilii/deribit-wrapper' }],
			stackIds: ['python'],
		},
		{
			id: 'bitcoin-utxo-lp',
			...
			kind: 'personal',
			summary: L.en('Bitcoin UTXO coin-selection via LP/MILP optimisation.', 'Selezione UTXO Bitcoin con ottimizzazione LP/MILP.'),
			links: [{ label: L.en('GitHub', 'GitHub'), href: 'https://github.com/AntonioVentilii/bitcoin-utxo-lp' }],
			stackIds: ['python'],
		},
		{
			id: 'juno-ecosystem',
		...
		},
		{
			...
			links: [{ label: L.en('AntonioVentilii on GitHub', 'Profilo GitHub'), href: 'https://github.com/AntonioVentilii?tab=repositories' }],
		},
	],
	technologies: [
		{
			...
			blurb: L.en('Primary language for OISY frontend/tooling and many side projects.', 'Linguaggio principale per OISY e molti side project.'),
		...
		},
		{
			...
			blurb: L.en('Canisters, icdc-core, vault-core, icrc-factory, performance-sensitive on-chain logic.', 'Canister Rust, icdc-core, vault-core, icrc-factory.'),
			relatedProjectIds: ['oisy', 'icdc-core', 'vault', 'icrc-factory'],
		},
		{
			id: 'python',
			label: L.en('Python', 'Python'),
			blurb: L.en('Trading desks, APIs, optimisation (LP), data pipelines, wrappers (Deribit, WhatsApp, Firestore).', 'Desk trading, API, LP, pipeline dati, wrapper vari.'),
			relatedProjectIds: ['deribit-wrapper', 'bitcoin-utxo-lp'],
		},
		{
			id: 'svelte',
			label: L.en('Svelte', 'Svelte'),
			blurb: L.en('OISY UI, vici-app, this portfolio — lean reactivity and small bundles.', 'UI OISY, vici-app, questa portfolio.'),
			relatedProjectIds: ['oisy', 'vici-app'],
		},
		{
			id: 'icp',
			label: L.en('Internet Computer', 'Internet Computer'),
			blurb: L.en('Canisters, Internet Identity, chain-key patterns, Internet Computer as host for OISY.', 'Canister, Internet Identity, chain-key; host di OISY.'),
			relatedProjectIds: ['oisy', 'icdc-core', 'icrc-factory', 'juno-ecosystem'],
		},
		{
			id: 'evm-solana',
			label: L.en('EVM & Solana', 'EVM e Solana'),
			blurb: L.en('WalletConnect, multi-chain expansion in OISY: EVM family + Solana semantics.', 'WalletConnect, più chain in OISY: famiglia EVM + Solana.'),
			relatedProjectIds: ['oisy'],
		},
		{
			id: 'react',
			label: L.en('React', 'React'),
			blurb: L.en('Desk-era internal apps and escrow front-end.', 'App interne da desk e frontend escrow.'),
	...
	education: [
		{
			...
			degree: L.en("Master's in Aeronautics Engineering (exchange)", 'Magistrale in Ingegneria Aeronautica (exchange)'),
	...
	orgHighlights: [
		...
		},
		{
			...
			note: L.en('Organisation home for the Internet Computer stack and ecosystem.', 'Organizzazione Internet Computer e ecosistema.'),
		},
	],
};
